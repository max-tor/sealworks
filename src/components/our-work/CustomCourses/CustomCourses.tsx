...
export const CustomCourses = () => {
  return (
    <section className="my-5 flex max-w-full flex-row-reverse gap-5 max-lg:flex-col lg:my-14 lg:gap-[40px] xl:gap-[116px]">
      ...
      <aside className="lmy-5 relative mx-auto mr-[4.243281471004243%] mt-[5.597014925373134%] grid h-[89.95756718528996vw] w-full gap-4 bg-blue max-lg:ml-0 max-lg:mt-10 max-lg:w-full max-lg:max-w-full lg:my-14 lg:h-[636px] lg:w-[707px] lg:flex-[1_0_707px] lg:flex-col">
        <StaticImage
          className="!absolute left-[6.789250353606789%] top-[7.462686567164178%] h-[58.2089552238806%] w-[66.76096181046675%] object-cover"
        ...
        />
        <StaticImage
          className="!absolute -left-[0.9900990099009901%] top-[6.7164179104477615%] h-[63.43283582089553%] w-[18.387553041018386%] select-none object-cover"
          imgClassName="h-auto max-w-full"
          alt={img1.alt}
          src="images/girl.png"
        ...
        />
        <StaticImage
          className="!absolute -top-[5.597014925373134%] left-[64.49787835926449%] h-[33.02238805970149%] w-[34.22913719943423%] object-cover"
          imgClassName="h-auto max-w-full"
          alt={img3.alt}
        ...
        />
        <StaticImage
          className="!absolute left-[12.871287128712872%] top-[64.15094339622641%] h-[37.42138364779874%] w-[56.57708628005658%] object-cover"
          imgClassName="h-auto max-w-full"
          alt={img4.alt}
        ...
        />
        <StaticImage
          className="!absolute left-[2.1216407355021216%] top-[60.22012578616353%] h-[32.38993710691824%] w-[14.144271570014144%] object-cover"
          imgClassName="h-auto max-w-full"
          alt={img5.alt}
        ...
        />
        <StaticImage
          className="!absolute left-[58.27439886845828%] top-[49.056603773584904%] h-[40.25157232704403%] w-[45.96888260254597%] object-cover"
          imgClassName="h-auto max-w-full"
          alt={img6.alt}
