  ...
  return (
    <section className="relative my-5 flex max-w-full flex-row-reverse gap-5 max-lg:flex-col lg:my-14 lg:gap-[20px] xl:gap-[110px]">
      ...
      <aside className="relative mx-auto grid h-[76.21696801112657vw] w-full gap-4 max-lg:ml-0 max-lg:mt-10 max-lg:w-full max-lg:max-w-full lg:h-[548px] lg:w-[719px] lg:flex-[1_0_712px] lg:flex-col">
        ...
        />
        <StaticImage
          className="!absolute left-[54.65924895688457%] top-[46.715328467153284%] h-[51.277372262773724%] w-[41.58553546592489%] shadow-lg"
          imgClassName="object-fill"
          alt={img1.alt}
        ...
        <StaticImage
          className="!absolute left-[11.404728789986091%] top-[68.97810218978103%] h-[31.02189781021898%] w-[42.698191933240615%] shadow-lg"
          imgClassName="object-fill"
          alt={img3.alt}
