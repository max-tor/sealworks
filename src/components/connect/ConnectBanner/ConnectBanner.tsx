...
export const ConnectBanner: React.FC = () => {
  return (
    <section className="relative flex max-w-full gap-5 max-lg:flex-col lg:my-5 lg:gap-[45px]">
      ...
      <aside className="relative mx-auto grid w-full flex-[1_0_634px] gap-4 max-lg:w-full max-lg:max-w-full lg:h-[348px] lg:w-[64%] lg:flex-col">
        ...
        <div className="font-bethellen text-3xl font-normal leading-10 lg:absolute lg:left-[400px] lg:top-px">
          jam sessions
        </div>
